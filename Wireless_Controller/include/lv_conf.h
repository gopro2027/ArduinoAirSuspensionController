 ...
 * - LV_STDLIB_CLIB:        Standard C functions, like malloc, strlen, etc. 0.2% decrease in memory usage by using this instead of builtin
 * - LV_STDLIB_MICROPYTHON: MicroPython implementation
 * - LV_STDLIB_RTTHREAD:    RT-Thread implementation
 * - LV_STDLIB_CUSTOM:      Implement the functions externally
 */
/* Allow overriding these from build flags (e.g. per-board) */
#ifndef LV_USE_STDLIB_MALLOC
    #define LV_USE_STDLIB_MALLOC    LV_STDLIB_BUILTIN // set these to builtin to free some memory for bluetooth
#endif
...
#define LV_FONT_MONTSERRAT_12 1 /* DPI font scaling (getScaledFont) ; was: 0 */
#define LV_FONT_MONTSERRAT_14 1
#define LV_FONT_MONTSERRAT_16 1
#define LV_FONT_MONTSERRAT_18 1 /* DPI font scaling (getScaledFont) ; was: 0 */
#define LV_FONT_MONTSERRAT_20 1
#define LV_FONT_MONTSERRAT_22 1 /* DPI font scaling (getScaledFont) ; was: 0 */
#define LV_FONT_MONTSERRAT_24 1 /* DPI font scaling (getScaledFont) ; was: 0 */
#define LV_FONT_MONTSERRAT_26 0
#define LV_FONT_MONTSERRAT_28 1 /* DPI font scaling (getScaledFont) ; was: 0 */
#define LV_FONT_MONTSERRAT_30 0
#define LV_FONT_MONTSERRAT_32 1 /* DPI font scaling (getScaledFont) ; was: 0 */
