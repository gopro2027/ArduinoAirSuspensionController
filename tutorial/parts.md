...
| --------- | ------- | ------- | ------- | ------- |
| FQP30N06L mosfet     |     9    | ![image](https://github.com/user-attachments/assets/a3c97586-92e9-4a2b-ac86-40f317dc5ced) | [ebay](https://www.ebay.com/itm/171395648380) | Linked is a pack of 50 but you may want to find a smaller pack of 10 |
...
| 1N4007 diode |    10     | ![image](https://github.com/user-attachments/assets/daae6c1d-b7ca-4330-b604-794b2f88379b) | [ebay](https://www.ebay.com/itm/235235061574) | Linked is a pack of 100 but you may want to find a smaller pack of 10 |
...
| 2.54mm pin headers |    Assorted      | ![image](https://github.com/user-attachments/assets/f4404869-27d4-40ed-8003-937a9998015d) | [amazon](https://www.amazon.com/gp/product/B07MN2MF1D) | You only need 2 x 15 female headers for mounting the esp32. Technically this is optional, but highly recommended in case your esp32 ever needs replaced so you don't have to rebuild the whole board. It also gives plenty of space to mount the components underneath the esp32 |
| ADS1115 |    2     | ![image](https://github.com/user-attachments/assets/31fdfe86-8bbc-4eab-8224-19a8565d94ff) | [amazon](https://www.amazon.com/gp/product/B0CNV9G4K1) | You can opt to purchase and install only 1 if you disable the height sensor code in the esp32 configuration file. |
| 4 Channels IIC I2C Logic Level Converter Bi-Directional 3.3V-5V Shifter Module |   1      | ![image](https://github.com/user-attachments/assets/3a9aa1b9-83d0-4efb-8649-06e1c845b9c5) | [amazon](https://www.amazon.com/dp/B07F7W91LC) | Pin headers required (as pictured) |
