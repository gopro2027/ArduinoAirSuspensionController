...
static uint16_t status_characteristic_value_handle = ATT_CHARACTERISTIC_66fda100_8972_4ec7_971c_3fd30b3072ac_01_VALUE_HANDLE;
static uint16_t status_characteristic_client_configuration_handle = ATT_CHARACTERISTIC_66fda100_8972_4ec7_971c_3fd30b3072ac_01_CLIENT_CONFIGURATION_HANDLE;
// static uint16_t rest_characteristic_handle;
static uint16_t rest_characteristic_value_handle = ATT_CHARACTERISTIC_f573f13f_b38e_415e_b8f0_59a6a19a4e02_01_VALUE_HANDLE;
static uint16_t rest_characteristic_client_configuration_handle = ATT_CHARACTERISTIC_f573f13f_b38e_415e_b8f0_59a6a19a4e02_01_CLIENT_CONFIGURATION_HANDLE;
// static uint16_t valve_control_characteristic_handle;
static uint16_t valve_control_characteristic_value_handle = ATT_CHARACTERISTIC_e225a15a_e816_4e9d_99b7_c384f91f273b_01_VALUE_HANDLE;
static uint16_t valve_control_characteristic_client_configuration_handle = ATT_CHARACTERISTIC_e225a15a_e816_4e9d_99b7_c384f91f273b_01_CLIENT_CONFIGURATION_HANDLE;
...
static int att_write_callback(hci_con_handle_t con_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset, uint8_t *buffer, uint16_t buffer_size)
{
    ...
    if (att_handle == status_characteristic_client_configuration_handle)
    {
        ...
        status_characteristic_client_configuration = little_endian_read_16(buffer, 0); // setting status_characteristic_client_configuration to 1
        return 0;
    }
    if (att_handle == rest_characteristic_client_configuration_handle)
    {
