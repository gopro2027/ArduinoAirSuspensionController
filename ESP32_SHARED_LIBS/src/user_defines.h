...
#define SENSORLESS_LEVEL_THRESHOLD_PSI 5      // min sustained deviation from baseline before acting
...
#define SENSORLESS_LEVEL_COOLDOWN_MS 15000    // min time between corrections on a given corner
